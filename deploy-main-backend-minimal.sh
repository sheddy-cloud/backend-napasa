...
echo "🚀 Deploying NAPASA Main Backend (Minimal - Auth Only)"
echo "====================================================="
...
echo "3. Copying essential files..."
cp server.js /var/www/napasa-main-backend/
cp package.json /var/www/napasa-main-backend/
cp -r src/ /var/www/napasa-main-backend/
cp -r middleware/ /var/www/napasa-main-backend/
cp -r routes/auth.js /var/www/napasa-main-backend/routes/
cp -r routes/users.js /var/www/napasa-main-backend/routes/
mkdir -p /var/www/napasa-main-backend/routes
...
# Create minimal PM2 ecosystem file
...
echo ""
echo "🎉 Minimal Main Backend deployment completed!"
echo ""
echo "📋 Check status:"
echo "   pm2 status"
