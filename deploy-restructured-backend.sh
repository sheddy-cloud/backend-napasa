...
echo "🚀 Deploying Restructured NAPASA Main Backend"
echo "============================================="
...
# Copy restructured files
echo "3. Copying restructured files..."
...
echo "8. Starting restructured backend with PM2..."
...
echo ""
echo "🎉 Restructured Main Backend deployment completed!"
echo ""
